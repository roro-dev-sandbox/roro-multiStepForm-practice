...
export function Step2SelectPlanItem({
    ...
    return (
        <ControllerInputRadio
            className={`flex-1 space-y-8 rounded-lg p-4 border ${isSelected ? "bg-gray-50 border-purple-700" : "border-gray-200"} hover:bg-gray-50 hover:border-purple-700 transition-colors duration-300 cursor-pointer`}
            control={control}
            name="plan"
