    ...
    return (
        <div className={`flex-1 flex flex-col gap-2 ${className}`}>
            ...
            <input
                ...
                disabled={disabled}
                value={field.value || ""}
                className={`rounded-sm outline-1 text-blue-950 font-medium py-2 px-4 ${hasError ? "outline-red-500 focus:outline-red-500" : "outline-gray-300 focus:outline-blue-950"}`}
            />
        </div>
    );
}
